...
public class AboutInnerClasses {
    ...
    public void innerClassAndInheritance() {
        ...
        //         it has to extend its parent class to be AboutInnerClasses
    ...
    public void innerClassAndInheritanceOther() {
        ...
        // Answer: OtherInner extends AboutInnerClasses in line 119
    ...
    public void staticInnerClass() {
        ...
        // x and 'theAnswer' belong to AboutInnerClass, although staticInnerClass is
        // inside AboutInnerClass, it does not mean they are the same.
